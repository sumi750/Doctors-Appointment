...
const Appointment = () => {
  ...
  const { doctors, currenySymnol, backendURL, getDoctorData, token } =
  ...
  useEffect(() => {
    const fetchDocInfo = async () => {
      ...
      if (!foundDoc) {
        return console.error("Doctor not found");
      }
      setDocInfo(foundDoc);
    };
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white shadow-lg mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
          ...
          <div>
            ...
            <p className="text-gray-600 max-w-[700px] mt-1 text-sm ">
              {docInfo.about}
            </p>
          </div>
